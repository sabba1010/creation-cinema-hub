...
const FILMS = [
  { img: creationcase, title: "The Creation Case", year: "2025", runtime: "98 min", genre: "Documentary" },
  { img: earth, title: "Great Earth", year: "2024", runtime: "84 min", genre: "Nature · Faith" },
  { img: prayer, title: "Rise & Pray", year: "2025", runtime: "62 min", genre: "Spiritual" },
];
    ...
    <section id="watch" className="relative bg-forest-deep py-24 text-cream sm:py-32">
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex items-end justify-between flex-wrap gap-4">
          ...
          <a href="#" className="text-sm font-semibold text-cream/80 hover:text-gold transition">All films →</a>
        </div>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {FILMS.map((f, idx) => (
            <article
              key={f.title}
              className={`group relative overflow-hidden rounded-3xl ring-1 ring-cream/10 transition-all duration-700 hover:ring-gold/40 ${idx === 0 ? "md:col-span-1 md:row-span-2 md:aspect-[3/4]" : "aspect-[3/4]"}`}
            >
              ...
              <button className="absolute inset-0 m-auto grid h-16 w-16 place-items-center rounded-full bg-cream/15 backdrop-blur-md ring-1 ring-cream/40 transition-all duration-500 group-hover:scale-110 group-hover:bg-gold">
