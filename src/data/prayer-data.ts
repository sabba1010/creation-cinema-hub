...
export const PRAYER_SERIES: PrayerSeries[] = [
  {
    ...
    videos: [
      {
        ...
        description:
          "Exploring Psalm 1 — what it means to be deeply rooted in God's Word and why that matters for everyday life.",
        duration: "47:12",
        thumbnail:
      ...
      },
      {
        ...
        description:
          "The church as a forest — how believers strengthen each other through shared rootedness in Christ and community.",
        duration: "49:20",
        thumbnail:
      ...
      },
      {
        id: "v5",
        day: 5,
        title: "A Living Hope — Commissioning Night",
        speaker: "Bishop Emmanuel Asante",
        description:
          "The closing night service — a night of praise, recommitment, and sending the global church out rooted in living hope.",
        duration: "1:08:44",
        thumbnail:
    ...
    resources: [
      {
        day: 1,
        title: "Day 1: Planted",
        scripture: "Psalm 1:1-3 — 'Blessed is the one who does not walk in step with the wicked... that person is like a tree planted by streams of water.'",
        devotional:
          "Roots are invisible — but they determine everything. Today we reflect on what our lives are planted in. Are we nourished by God's Word daily, or surviving on spiritual junk food? A tree planted by streams doesn't strive for water; it absorbs it naturally through proximity. Move close to the source today.",
        prayerPoints: [
      ...
      },
      {
        ...
        scripture: "Job 1:21 — 'The Lord gave and the Lord has taken away; may the name of the Lord be praised.'",
        devotional:
          "Job lost everything — but not his roots. The storm revealed what was already there beneath the surface. When life shakes you, your response reveals your depth. Deep roots don't prevent storms; they transform how you experience them. Today, name your storm. Then name your Root.",
        prayerPoints: [
      ...
      },
      {
        ...
        devotional:
          "Not every season looks fruitful — and that's okay. Autumn strips the tree bare so that winter can rest it and spring can explode with new life. If you're in a dry season, you are not forgotten. God is working underground. The roots go deepest when the soil seems driest.",
        prayerPoints: [
      ...
      },
      {
        ...
        devotional:
          "A single tree can topple in a storm. A forest stands. When trees grow close together, their roots intertwine beneath the soil — sharing nutrients, anchoring each other. The church is meant to be this kind of community. Today, consider: whose roots are you intertwined with?",
        prayerPoints: [
      ...
      },
      {
        ...
        scripture: "John 15:16 — 'You did not choose me, but I chose you and appointed you so that you might go and bear fruit — fruit that will last.'",
        devotional:
          "The final night is not an ending — it's a sending. Everything we've received this week is seed to be sown. Your roots are not for you alone; they're the source from which your fruit blesses others. Go. Be planted in your community. Bear fruit in your generation.",
        prayerPoints: [
    ...
    downloads: [
      {
        id: "d1",
        title: "Week of Prayer 2026 — Study Guide",
        type: "PDF",
        size: "3.2 MB",
      ...
      {
        id: "d3",
        title: "Children's Curriculum — Rooted in Him",
        type: "PDF",
        size: "8.7 MB",
      ...
      {
        id: "d4",
        title: "Sermon Slides — All 5 Nights",
        type: "PPTX",
        size: "22 MB",
      ...
      {
        id: "d5",
        title: "Social Media Kit — WOP 2026",
        type: "ZIP",
        size: "15 MB",
  ...
  },
  {
    ...
    description:
      "Five transformative nights exploring how God speaks — through Scripture, community, nature, silence, and suffering. One of our most impactful series to date, drawing 40,000+ viewers from 68 countries.",
    thumbnail:
    ...
    videos: [
      {
        id: "v1",
        day: 1,
        title: "He Speaks — Are We Listening?",
      ...
      },
      {
        ...
        description: "The hardest and most powerful message of the series — how God's voice is often loudest in our suffering.",
        duration: "55:49",
        thumbnail:
          "https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?auto=format&fit=crop&q=80&w=600",
        videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
      ...
      },
      {
        id: "v5",
        day: 5,
        title: "Responding to the Voice — A Call to Action",
        speaker: "Bishop Emmanuel Asante",
    ...
    resources: [
      {
        ...
        devotional: "Samuel was sleeping in the very presence of God and didn't recognize His voice until he was taught how to listen. Many of us are in the same place — surrounded by God's presence, but unaware of His voice. Today, we simply practice listening.",
        prayerPoints: [
          "Ask God to open your spiritual ears",
          "Spend 5 minutes in silence — just listening",
      ...
      },
      {
        ...
        devotional: "We sometimes treat the Bible like a history book — interesting but distant. But the Word of God is described as alive. It breathes. It speaks. Today, don't just read Scripture — listen to it. Ask: 'God, what are you saying to me through this passage, today, in my specific situation?'",
        prayerPoints: [
      ...
      },
      {
        ...
        devotional: "Elijah expected fire and earthquake — but God came in a whisper. We are trained by our culture to expect the spectacular. But God often chooses the subtle, the soft, the still. What if the reason we can't hear Him is because we've never practiced quietness?",
        prayerPoints: [
          ...
          "Thank God for meeting Elijah in his exhaustion — and for meeting you in yours",
        ],
      },
      {
        day: 4,
      ...
      {
        day: 5,
        title: "Day 5: Here I Am — Send Me",
        scripture: "Isaiah 6:8 — 'Then I heard the voice of the Lord saying, \"Whom shall I send?\" And I said, \"Here am I. Send me!\"'",
    ...
    downloads: [
      {
        id: "d1",
        title: "The Voice of God — Study Guide 2025",
        type: "PDF",
        size: "4.1 MB",
      ...
      {
        id: "d3",
        title: "Audio Sermon Collection — All 5 Nights",
        type: "ZIP",
        size: "180 MB",
      ...
      {
        id: "d4",
        title: "Youth Discussion Guide — The Voice of God",
        type: "PDF",
        size: "5.8 MB",
      ...
      {
        id: "d5",
        title: "Printable Prayer Journal — 30 Days",
        type: "PDF",
        size: "6.2 MB",
  ...
  },
  {
    ...
    description:
      "A landmark series that launched the Week of Prayer Online format. Five nights exploring the theme of renewal — personally, spiritually, and globally. Watched by over 28,000 people from 54 countries.",
    thumbnail:
    ...
    videos: [
      {
        ...
        speaker: "Pastor James Osei",
        description: "The opening night message on Isaiah 43 — God's invitation to stop living in the past and step into what He is creating.",
        duration: "49:22",
      ...
      },
      {
        ...
        speaker: "Dr. Sarah Mensah",
        description: "Romans 12:2 — How transformation begins in the mind and how to practically renew your thought life.",
        duration: "53:10",
      ...
      },
      {
        ...
        speaker: "Dr. Kwame Asante",
        description: "The God who specializes in restoration — broken relationships, broken faith, broken dreams.",
        duration: "47:55",
      ...
      },
      {
        ...
        title: "A New Song",
        speaker: "Elder Ruth Amponsah",
        description: "The role of worship in personal and communal renewal — and why singing matters more than we think.",
        duration: "44:30",
      ...
      },
      {
        id: "v5",
        day: 5,
        title: "New Creation — Living from the Future",
        speaker: "Bishop Emmanuel Asante",
    ...
    resources: [
      ...
      { day: 5, title: "Day 5: New Creation", scripture: "2 Corinthians 5:17", devotional: "You are not who you were. In Christ, the old is gone and the new has come. Today, live from this identity — not as someone trying to be new, but as someone who already is.", prayerPoints: ["Declare your identity in Christ out loud", "Ask God how to live more fully as a new creation", "Pray for one person who needs to experience new life"] },
    ],
    downloads: [
      { id: "d1", title: "All Things New — Study Guide 2024", type: "PDF", size: "3.8 MB", description: "Complete 5-day devotional study guide from the inaugural Week of Prayer Online series.", locked: false },
