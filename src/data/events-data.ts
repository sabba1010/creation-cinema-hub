...
export const INITIAL_EVENTS: Event[] = [
  {
    ...
    capacity: 200,
    price: "$45.00",
    description: "A fun-filled week of learning and growing in faith for children ages 5-12.",
  ...
  },
  {
    ...
    capacity: 500,
    price: "$20.00",
    description: "Join us for an evening of powerful worship and community prayer.",
  ...
  },
  {
    ...
    capacity: 1000,
    price: "$15.00",
    description: "Equipping the next generation of ministry leaders with practical tools and spiritual insights.",
  ...
  },
  {
    ...
    capacity: 50000,
    price: "Free",
    description: "Seven nights of worship, teaching, and guided prayer streamed live to homes worldwide.",
